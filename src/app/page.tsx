...
import { type HomePagaData } from "@/app/sharedTypes";

export default function HomePage() {
  const [homeData, setHomeData] = useState<HomePagaData | null>(null);
      ...
      <div className="p-6 text-gray-100 bg-gray-900 min-h-screen">
        ...
        <div className="mt-6">
          ...
          <table className="w-full border mt-4 bg-gray-800 text-gray-100 shadow-md rounded-lg">
            ...
            <tbody>
              {homeData.comparisonTable?.map((storage, index) => (
                <tr
                  key={index}
        ...
        <div className="mt-8 text-sm text-gray-400">
          ...
          <ul className="list-disc list-inside">
            {homeData.sources?.map((source, index) => (
